...
public class CZhelp implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        sender.sendMessage(ChatColor.translateAlternateColorCodes('&',"&e插件设置菜单 &f/&aCZSetting"));
        sender.sendMessage(ChatColor.translateAlternateColorCodes('&',"&e踢出玩家菜单 &f/&akickGUI"));
